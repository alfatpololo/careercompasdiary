...
const defaultQuestions = [
  'Saya memahami pentingnya memiliki sikap percaya diri dalam menghadapi berbagai tantangan karier.',
  'Saya mampu menjelaskan kembali makna dan manfaat kepercayaan diri (Confidence) bagi perkembangan karier saya.',
  'Saya merasa lebih yakin terhadap kemampuan diri saya setelah mengikuti kegiatan layanan ini.',
  'Saya dapat menjawab soal-soal gamifikasi dengan baik karena memahami materi yang disampaikan.',
  'Saya berkomitmen untuk terus mengembangkan rasa percaya diri dalam menghadapi tugas dan tantangan karier di masa depan.',
];

export default function ConfidenceEvaluationResultStudent() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const res = await fetch('/api/cms/evaluation?stage=confidence');
      ...
      <div className="max-w-6xl mx-auto mt-16">
        <GameCard>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h2 className="text-3xl font-extrabold text-white drop-shadow mb-4">Evaluasi Hasil - Confidence</h2>
          ...
          <div className="flex justify-between mt-6 pt-4 border-t-2 border-white/30">
            <GameButton onClick={() => router.push('/confidence')} className="from-gray-400 to-gray-600">Cancel</GameButton>
