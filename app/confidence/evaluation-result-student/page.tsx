      ...
      >
        <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-600">
            Silakan login terlebih dahulu untuk mengisi evaluasi hasil tahap Confidence.
          </p>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <h1 className="text-3xl font-extrabold drop-shadow mt-2">Evaluasi Hasil Tahap Confidence</h1>
            <p className="text-white/85 font-semibold max-w-2xl">
              Ceritakan dampak layanan Confidence terhadap keyakinanmu dalam menghadapi karier.
            </p>
          </div>
