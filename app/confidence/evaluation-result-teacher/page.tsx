...
export default function ConfidenceEvaluationResultTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi hasil guru BK untuk tahap Confidence berhasil disimpan! ✅');
      router.push('/confidence');
    } catch (error) {
      console.error('[Confidence Evaluation Teacher Result] Error:', error);
        ...
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai dampak layanan Confidence terhadap kepercayaan diri siswa dalam menghadapi karier.
            </p>
          </div>
