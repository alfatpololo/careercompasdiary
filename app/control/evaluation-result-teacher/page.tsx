...
export default function ControlEvaluationResultTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi hasil guru BK untuk tahap Control berhasil disimpan! ✅');
      router.push('/control');
    } catch (error) {
      console.error('[Control Evaluation Teacher Result] Error:', error);
      ...
      >
        <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-600">
            Silakan login terlebih dahulu untuk mengisi evaluasi hasil tahap Control.
          </p>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <h1 className="text-3xl font-extrabold drop-shadow mt-2">Evaluasi Hasil Tahap Control</h1>
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai sejauh mana siswa menginternalisasi materi kendali diri serta dampaknya terhadap persiapan karier.
            </p>
          </div>
