...
const questions = [
  'Saya melaksanakan layanan dengan tujuan menumbuhkan pemahaman siswa tentang pentingnya kendali diri dalam mengelola arah kariernya',
  'Saya menyampaikan instruksi materi kendali diri (Control) dengan jelas, terstruktur, dan sesuai dengan kebutuhan siswa yang ada dalam website',
  'Saya membimbing siswa agar mampu menunjukkan sikap kemandirian, tanggung jawab, dan disiplin selama kegiatan layanan berlangsung',
  'Saya membantu siswa memahami konsep kendali diri selama proses layanan',
  'Saya memastikan seluruh proses kegiatan berjalan lancar, terarah, dan sesuai dengan tujuan layanan yang telah direncanakan',
];
...
const instructions = [
  ...
  '• 12–15 : Sudah baik dan mandiri pada tahap Control (tinggi)',
];

export default function ControlEvaluationProcessTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses guru BK untuk tahap Control berhasil disimpan! ✅');
      router.push('/control');
    } catch (error) {
      console.error('[Control Evaluation Teacher Process] Error:', error);
      ...
      >
        <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-600">
            Silakan login terlebih dahulu untuk mengisi evaluasi proses tahap Control.
          </p>
    ...
    >
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            <GameBadge className="bg-emerald-500/80 border-white">Guru BK</GameBadge>
            <h1 className="text-3xl font-extrabold drop-shadow mt-2">Evaluasi Proses Tahap Control</h1>
            <p className="text-white/85 font-semibold max-w-2xl">
              Gunakan lembar observasi ini untuk menilai pelaksanaan layanan Career Compass Diary pada tahap kendali diri.
            </p>
          </div>
