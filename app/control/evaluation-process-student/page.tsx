...
export default function ControlEvaluationProcessStudent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses siswa tahap Control berhasil disimpan! ✅');
      router.push('/control/evaluation-result-student');
    } catch (error) {
      console.error('[Control Evaluation Student Process] Error:', error);
    ...
    >
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            <GameBadge className="bg-emerald-500/80 border-white">Siswa</GameBadge>
            ...
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai pengalamanmu selama mengikuti layanan Control agar guru bisa memahami kebutuhanmu.
            </p>
          </div>
