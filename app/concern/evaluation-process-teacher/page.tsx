...
export default function ConcernEvaluationProcessTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses guru BK berhasil disimpan! ✅');
      router.push('/concern');
    } catch (error) {
      console.error('[Concern Evaluation Teacher Process] Error:', error);
    ...
    >
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            <GameBadge className="bg-indigo-500/80 border-white">Guru BK</GameBadge>
            ...
            <p className="text-white/85 font-semibold max-w-2xl">
              Gunakan lembar observasi ini untuk menilai proses pelaksanaan layanan Career Compass Diary
              pada tahap kepedulian karier.
            </p>
          </div>
