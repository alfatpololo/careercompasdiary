...
export default function ConcernEvaluationResultTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi hasil guru BK berhasil disimpan! ✅');
      router.push('/concern');
    } catch (error) {
      console.error('[Concern Evaluation Teacher Result] Error:', error);
        ...
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai hasil pembelajaran siswa setelah mengikuti layanan gamifikasi pada tahap Concern.
            </p>
          </div>
