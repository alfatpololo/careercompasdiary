...
export default function ConcernEvaluationResultStudent() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const res = await fetch('/api/cms/evaluation?stage=concern');
      ...
      <div className="max-w-6xl mx-auto mt-16">
        <GameCard>
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <h2 className="text-3xl font-extrabold text-white drop-shadow mb-4">Evaluasi Hasil - Concern</h2>
          ...
          <div className="flex justify-between mt-6 pt-4 border-t-2 border-white/30">
            <GameButton onClick={() => router.push('/concern')} className="from-gray-400 to-gray-600">Cancel</GameButton>
