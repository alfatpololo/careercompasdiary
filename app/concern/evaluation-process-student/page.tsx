...
const questions = [
  'Saya memahami tujuan kegiatan tahap (Concern) peduli terhadap karier masa depan.',
  'Saya memahami materi dengan jelas dan mudah dipahami pada tahap kepedulian karier.',
  'Saya memahami pentingnya merencanakan karier sejak dini selama kegiatan layanan berlangsung.',
  'Saya memahami materi dengan cara soal-soal gamifikasi yang diberikan menyenangkan.',
  'Proses pelaksanaan layanan berlangsung dengan baik, terarah, dan membuat saya lebih memahami kepedulian terhadap karier masa depan.',
];
...
export default function ConcernEvaluationProcessStudent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses siswa berhasil disimpan! ✅');
      router.push('/concern/evaluation-result-student');
    } catch (error) {
      console.error('[Concern Evaluation Student Process] Error:', error);
      ...
      >
        <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-600">
            Silakan login terlebih dahulu untuk mengisi evaluasi proses tahap Concern.
          </p>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <h1 className="text-3xl font-extrabold drop-shadow mt-2">Evaluasi Proses Tahap Concern</h1>
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai pengalamanmu selama mengikuti layanan tahap Concern di Career Compass Diary.
            </p>
          </div>
