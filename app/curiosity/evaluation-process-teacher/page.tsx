...
export default function CuriosityEvaluationProcessTeacher() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses guru BK untuk tahap Curiosity berhasil disimpan! ✅');
      router.push('/curiosity');
    } catch (error) {
      console.error('[Curiosity Evaluation Teacher Process] Error:', error);
        ...
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <p className="text-white/85 font-semibold max-w-2xl">
              Gunakan lembar observasi ini untuk menilai pelaksanaan layanan Curiosity dan tingkat keterlibatan siswa.
            </p>
          </div>
