...
const questions = [
  'Saya berusaha memahami materi Curiosity (rasa ingin tahu) dalam eksplorasi karier.',
  'Saya terlibat aktif dalam kegiatan layanan yang membahas materi keingintahuan (Curiosity).',
  'Saya merasa antusias mengikuti setiap tahapan kegiatan gamifikasi yang diberikan oleh guru BK.',
  'Saya berusaha menjawab soal-soal gamifikasi dengan sungguh-sungguh selama proses kegiatan berlangsung.',
  'Saya menunjukkan keberanian untuk mengeksplorasi berbagai peluang karier melalui aktivitas layanan catatan harian yang diberikan.',
];
...
export default function CuriosityEvaluationProcessStudent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Evaluasi proses siswa tahap Curiosity berhasil disimpan! ✅');
      router.push('/curiosity/evaluation-result-student');
    } catch (error) {
      console.error('[Curiosity Evaluation Student Process] Error:', error);
      ...
      >
        <div className="bg-white bg-opacity-95 rounded-xl shadow-2xl p-8 text-center max-w-md w-full">
          ...
          <p className="text-gray-600">
            Silakan login terlebih dahulu untuk mengisi evaluasi proses tahap Curiosity.
          </p>
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between text-white">
          <div>
            ...
            <h1 className="text-3xl font-extrabold drop-shadow mt-2">Evaluasi Proses Tahap Curiosity</h1>
            <p className="text-white/85 font-semibold max-w-2xl">
              Nilai pengalamanmu selama mengikuti layanan Curiosity agar guru memahami kebutuhan eksplorasimu.
            </p>
          </div>
